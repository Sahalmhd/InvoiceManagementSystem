                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('customers.update',$customer->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="email" id="name"value="{{$customer->email }}"class="form-control   @error('email ') is-invalid @enderror">
                            </div>
                            <div class="mb-3">
                                <label for="number" class="form-label">Phone</label>
                                <input type="tel" name="phone" id="name"value="{{$customer->phone }}"class="form-control   @error('phone') is-invalid @enderror">
                            </div>
                            <div class="mb-3">
